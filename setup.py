#!/usr/bin/env python
"""
Package metadata for gpteacher.
"""
import os
import re
import sys
...
VERSION = get_version('gpteacher', '__init__.py')
...
setup(
    name='gpteacher-xblock',
    version=VERSION,
    description="""GPTeacher""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/gpteacher-xblock',
    packages=find_packages(
        include=['gpteacher', 'gpteacher.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'xblock.v1': [
            'gpteacher = gpteacher:GPTeacherXBlock',
        ]
    },
    package_data=package_data("gpteacher", ["static", "public"]),
)
